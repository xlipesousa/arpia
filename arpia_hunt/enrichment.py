...
from .services import sync_heuristic_mappings, sync_recommendations_for_finding
...
def enrich_finding(
    ...
    *,
    ...
    heuristic_result = sync_heuristic_mappings(
        cve=finding.cve,
        finding=finding,
        records=records,
    )
    ...
    return records, heuristic_result.changed or profile_result.updated or rec_result.changed
